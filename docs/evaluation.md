...
M2→M3 +4.5pp（16 题改善、7 题回退，p=0.093）。GRPO 正式合同为 500 training
steps；本次在 optimizer step 100 通过受控 barrier 停止，并导出 step 100 作为 M3。
该结果方向正向但未达到 0.05 显著性水平，也不外推到其他配方。
